...
def main() -> int:
    ...
    assert_exists(ROOT / "xml" / "wikipedia" / "users" / "Khakbaz" / "profile.xml", "user page xml source", errors)
    assert_exists(ROOT / "build" / "wikipedia" / "userpages" / "User-Khakbaz.wikitext", "user page wikitext", errors)
    assert_exists(ROOT / "xml" / "wikipedia" / "templates" / "data-technology-navbox.xml", "navbox xml source", errors)
    assert_exists(ROOT / "build" / "wikipedia" / "templates" / "Template-Data-technology.wikitext", "navbox wikitext", errors)
